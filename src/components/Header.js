  ...
  return (
    <nav className="bg-[#DFDCD5] shadow-md">
      <div className="container mx-auto flex justify-between items-center p-4">
        ...
        <div className={`hidden md:flex md:text-xl space-x-4`}>
      ...
      <div className={`${isOpen ? "block" : "hidden"} md:hidden bg-[#DFDCD5]`}>
        <div className="flex flex-col items-start p-4 space-y-2">
          <Link className="text-gray-800 hover:text-white" to="/" onClick={() => setIsOpen(false)}>
            Home
          </Link>
          <Link className="text-gray-800 hover:text-white" to="/about" onClick={() => setIsOpen(false)}>
            About
          </Link>
          <Link className="text-gray-800 hover:text-white" to="/lessons" onClick={() => setIsOpen(false)}>
            Lessons
          </Link>
          <Link className="text-gray-800 hover:text-white" to="/hire" onClick={() => setIsOpen(false)}>
            Hire for Events
          </Link>
          <Link className="text-gray-800 hover:text-white" to="/contact" onClick={() => setIsOpen(false)}>
            Contact
          </Link>
        </div>
      </div>
