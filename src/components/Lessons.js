      ...
      <div className="flex flex-col justify-center items-center">
        <div className="w-3/4 md:w-2/3 lg:w-1/2 text-xl text-gray-800 dark:text-secondaryText">
          ...
          <ul className="list-disc list-inside ml-4 mb-6">
            ...
            <li>
              <strong>Basic Techniques:</strong> Mastering the essential finger
              movements and blowing techniques.
            </li>
            <li>
          ...
          <ul className="list-disc list-inside ml-4 mb-6">
            ...
            <li>
              ...
              maintain your bagpipe and keep it in tune for optimal performance.
            </li>
            <li>
          ...
          <p>
            Experienced pipers can take their playing to the next level with our
            advanced lessons:
          </p>
          <ul className="list-disc list-inside ml-4 mb-6">
            <li>
              <strong>Mastering Piobaireachd:</strong> Delving into the
          ...
          <ul className="list-disc list-inside ml-4 mb-6">
            <li>
              <strong>Personalized Instruction:</strong> Lessons are customized
              to fit your learning style and pace.
            </li>
            <li>
        ...
        <div className="w-2/3 md:w-1/3 mt-20 mb-20">
          <img src={image1} alt="Aaron playing the bagpipes"></img>
