        ...
        <div className="w-3/4 md:w-1/3 mr-10 text-xl text-gray-800 dark:text-secondaryText">
          <Fade cascade damping={0.1} triggerOnce>
            <p>
              ...
              resource in the Vancouver Island bagpiping scene. He has recently
              competed as a solo bagpiper at the grade 2 level and has been the
              bagpiper for the Celtic Punk band{" "}
              <a
          ...
          <Fade cascade damping={0.1} triggerOnce>
            <p>
              ...
              own wedding), and even played his bagpipes at the Ring of Brodgar
              in the Orkney Islands. As a teenager, he traveled to Scotland with
              his long time bagpipe instructor, Bill Grant, and competed in solo
